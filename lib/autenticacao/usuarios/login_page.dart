...
class LoginFunPage extends StatefulWidget {
  @override
  _LoginFunPage createState() => _LoginFunPage();
}

class _LoginFunPage extends State<LoginFunPage> {
  @override
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CadastroFunPage(),
                        ),
                      );
                    },
                    child: Text(
